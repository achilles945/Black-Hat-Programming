...
def plain_paste(title, contents):
    ...
    r = request.post(paste_url, data=paste_data)
    print(r.status_code)
    print(r.text)

# window specific techniques to perfrom paste using internet explorer
